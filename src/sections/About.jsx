      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              I specialize in modern technologies, programming languages, frameworks, databases, and developer tools to build scalable, secure, and high-performance applications.
            </p>
          </div>
